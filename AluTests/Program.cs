...
namespace AluTests
{
    class Program
    {
        ...
        private static string GetThisFolder([System.Runtime.CompilerServices.CallerFilePath] string path = null)
        {
        ...
        {
            var alu = new ALU();
            var file = new System.IO.StreamReader(System.IO.Path.Combine(GetThisFolder(), "..\\x86flags\\aludata.txt"));
            int failed = 0;
